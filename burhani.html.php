    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
          ...
          <div class="navbar-header page-scroll">
              ...
              <a class="navbar-brand" href="#page-top" style="font-family: Raleway; color: black; font-weight: 600"><span><img width="12%" src="assets/img/burhani1.png" alt="logo"></span>urhani Developer's</a>
          </div>
                  ...
                  <ul class="nav navbar-nav">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="divider"></li>
                            <li><a href="../index.php" class="-sign-out" name="signout">Sign Out <span class="glyphicon glyphicon-log-out pull-right"></span></a></li>
                        </ul>
                    </li>
                </ul>
              </ul>
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <div class="bu-txt">
                        ...
                        <a href="#"  data-toggle="popover" title="Burhani Developer" data-content="Some content inside the Button">Read More</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="section2-txt">
                    <div class="col-sm-6">
                        <div class="image">
                            <img width="56%" style="float: left !important;" src="assets/img/responsive.png" alt="section-2 image">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="text">
            ...
            <div class="container">
                <div class="row">
                    <div class="section2-txt">
                        <div class="col-sm-6">
                            <div class="image">
                                <img width="56%" style="float: left !important;" src="assets/img/gen-back-office-300x300.png" alt="section-2 image">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="text">
